...
class Params
{
  public:
    ...
    const char *class_name [num_classes] = {"Cone"};
    const float min_x_range = 0.0;
    const float max_x_range = 40.96;
    const float min_y_range = -30.72;
    const float max_y_range = 30.72;
    ...
    const float anchor_bottom_heights[num_classes] = {-0.7};
